          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900 cursor-pointer hover:text-indigo-700" onClick={() => navigate('/dashboard')}>Personal Finance Tracker</span>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <h1 className="text-3xl font-bold text-gray-900">{language === 'en' ? 'Transactions' : 'Giao dịch'}</h1>
            <button
