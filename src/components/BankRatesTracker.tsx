      ...
      <div className="px-6 py-4 bg-[#f5f3bb]/50 border-b border-[#f5f3bb]/60 relative z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#df2935] font-bold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <h3 className="text-lg font-semibold text-[#412722] relative z-10">
              {language === 'en' ? 'Bank Rates Tracker' : 'Theo dõi tỷ giá ngân hàng'}
            </h3>
          </div>
          <div className="flex items-center space-x-2 relative z-10">
            <span className={`h-2 w-2 rounded-full ${isLoading ? 'bg-[#dfa06e] animate-pulse' : 'bg-[#86ba90]'} relative z-10`}></span>
            <span className="text-xs text-[#412722] relative z-10 font-medium">
              {isLoading 
