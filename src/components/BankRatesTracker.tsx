      ...
      <div className="px-6 py-4 bg-[var(--bg-card-lightest)] border-b border-[var(--border-color)] relative z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 color-expense font-bold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex items-center space-x-2 relative z-10">
            <span className={`h-2 w-2 rounded-full ${isLoading ? 'bg-[var(--savings-color)] animate-pulse' : 'bg-[var(--income-color)]'} relative z-10`}></span>
            <span className="text-xs text-[var(--text-primary)] relative z-10 font-medium">
              {isLoading 
