      ...
      <div className="px-6 py-4 bg-gradient-to-r from-[#f5f3bb]/40 to-[#86ba90]/40 border-b border-[#f5f3bb]/50 relative z-10">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="mt-2 sm:mt-0 flex items-center space-x-3 relative z-10">
            <div className="text-sm font-medium text-[#412722]">
              {language === 'en' ? 'Total:' : 'Tổng cộng:'} 
              <span className="font-bold text-[#df2935] ml-1">
            ...
            <select
              ...
              className="input-focus block w-36 px-3 py-1.5 text-sm border border-[#dfa06e] rounded-lg shadow-sm focus:ring-[#df2935] focus:border-[#df2935] relative z-10 bg-white/70"
            >
